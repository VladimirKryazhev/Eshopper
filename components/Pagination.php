...
class Pagination
{
  ...
  // Запуск необходимых данных для навигации
   ...
   //Для вывода ссылок @return HTML-код со ссылками навигации
  ...
  // Для генерации HTML-кода ссылки @param integer $page - номер страницы @return
 ...
 // Для получения, откуда стартовать @return  массив с началом и концом отсчёта
...
// Для установки текущей страницы @return
...
//Для получения общего числа страниц @return числа страниц

    private function amount()
    {
        // Делим и возвращаем
        //return ceil($this->limit / $this->total);
        //return ceil($this->limit /2);
